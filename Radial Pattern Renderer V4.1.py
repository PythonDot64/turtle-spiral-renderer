...
rand = input("Random numerical settings? (type 'comfirm' to comfirm it and type 'deny' to deny it): ")
rand_dat = (0)
rand_int_dat1 = (0)
rand_int_dat2 = (0)
for_var = (0)
...
backround = input("Plz choose the backround colour from the above (case sensitave): ")

print("")

turtle.speed(render_speed)
b_col = turtle.Screen()
b_col.bgcolor(backround)
